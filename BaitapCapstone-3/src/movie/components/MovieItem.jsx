...
const MovieItem = ({ movie }) => {
  ...
  return (
    <div
      className="group relative bg-slate-900 rounded-xl overflow-hidden transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-orange-500/20 cursor-pointer group"
    ...
    >
      <div className="relative aspect-2/3 overflow-hidden">
        ...
        <div className="absolute top-2 right-2">
          <Tag
            color="warning"
            className="m-0 font-bold flex items-center gap-1 border-none bg-orange-500 text-white"
          >
      ...
      <div className="p-4 bg-slate-900">
        ...
        <p className="text-gray-400 text-sm line-clamp-2 h-10">{movie.moTa}</p>
